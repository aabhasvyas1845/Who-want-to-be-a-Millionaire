...
Download Files
Save the following project files into a single directory:
...
Execute the main file using the Python interpreter:
python main_kbc.py

✅ Instructions for Testing
The primary mode of testing is through validation tests by playing the game and verifying the core mechanics:
